...
**3) The fird subpage "Bivariate Normal Data" allows you to specify a correlation. Then, you cam look at the linear model for a bivariate data set calculated from this correlation and the Bayes factor for this linear model.**