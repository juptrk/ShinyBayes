...
#### 3) The third subpage "Bivariate Normal Data" allows you to specify a correlation. Then, you can look at the linear model for a bivariate data set calculated from this correlation and the Bayes factor for this linear model. The aim of this subpage is to make the concept of the Bayes factor more concrete and graspable and to show that the explained concepts aren't limited to coin flips but can be used for more complex data.
  
  
<img src="bayes.png" width = 35%>
